...
from wtforms import Form, StringField, PasswordField, BooleanField, DateField,HiddenField, SelectField, IntegerField, FloatField, SubmitField, TextAreaField
